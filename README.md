...
A collection of UI/UX project screenshots with short descriptions.
...
### Project Name
Short description of the project — what it is, your role, tools used.

![Project Name](screenshots/project-name.png)
...
![Project Name 2](screenshots/project-name-2.png)

---

## How to add a project

1. Drop your screenshot(s) in a `screenshots/` folder (create it if it doesn't exist).
2. Copy the project block above, rename the title, write a 1-3 sentence description.
3. Reference the image with a relative path: `screenshots/your-file.png`.
4. Commit and push.
